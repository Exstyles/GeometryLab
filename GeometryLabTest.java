public class GeometryLabTest {
    public static void main (String[] args) {
        ...
        System.out.println(geo.f(geo.j(10,5), geo.f(2,3)));
        ...
        System.out.println(geo.rectPyramid(5,7,9));
        System.out.println(geo.rectPyramid(4,6,8));
        ...
        System.out.println(geo.coneVol(10,3));
        ...
        System.out.println(geo.rectPyramid(geo.m(5,7,9), geo.m(4,6,8), geo.k(20,7)));
        System.out.println(geo.cylVol(geo.h(9,2), geo.k(10,3)));
        System.out.println(geo.sphereVol(geo.g(9,7)));
        System.out.println(geo.coneVol(geo.j(6,5), geo.j(8,7)));
        System.out.println(geo.sphereSurfArea(geo.m(4,3,1)));
        System.out.println(geo.cylSurfArea(4.0, geo.f(5,3)));
